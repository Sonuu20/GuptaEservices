                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li>
                                    <Link to="/github" className="hover:underline  hover:text-orange-700">
                                        Github
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li className="mb-4">
                                    <a
                                        href="https://www.instagram.com/ig_sonuu20/"
                                        className="hover:underline  hover:text-orange-700"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                ...
                                <li className="mb-4">
                                    <a
                                        href="https://www.facebook.com/profile.php?id=100027071682474"
                                        className="hover:underline hover:text-orange-700"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
